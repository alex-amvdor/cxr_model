...
description: Find the right file, command, or module in cxr_model before editing.
---
...
- Prefer `src/cxr_model/` for implementation changes.
...
2. Check whether a helper already exists in `src/cxr_model/`.
