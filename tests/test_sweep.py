...
from cxr_model.sweep import Sweep, build_cases, crystal_params, MATERIAL_LABELS
from cxr_model.config import MATERIALS

ALL = [
    "mose2", "wse2", "mote2", "mos2", "ws2",
    "ptse2", "hfse2", "zrse2", "diamond", "silicon", "hopg",
]
...
def test_build_cases_is_cartesian_product():
    ...
    required = {
        "crystal", "composition", "hkl_list", "B_ang2",
        "E0_keV", "thickness_ang", "theta_obs_rad", "tilt_deg",
    }
